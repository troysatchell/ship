...
describe('pgResult (typed pool.query mock factory)', () => {
  ...
  // The test title below names the phrase "as any" as prose (describing the
  // cast this factory replaces), not a cast — the line itself has none.
  // review-pattern-ok: title text, not a cast — see file header for the real cast this test proves is gone.
