-- Migration 051: validate webhook_deliveries.replayed_from_id's FK (PF-306 / TRO-446)
--
-- Migration 050 added the FK as NOT VALID (CodeRabbit, PR #229's review) to
...
-- 050) so the two lock profiles stay genuinely separate, matching Postgres's
