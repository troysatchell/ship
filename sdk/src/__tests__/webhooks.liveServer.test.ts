 ...
 * still-broken method. TRO-452 (`ship webhooks tail`) fixed that gap — see
 * the new "createSubscription()" case below, the first in this file to
 * exercise that method for real instead of seeding around it. Every OTHER
